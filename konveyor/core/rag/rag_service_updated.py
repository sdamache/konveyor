...
class RAGService:
    ...
    async def _init_conversation_manager(self):
        ...
        try:
            ...
            try:
                self.conversation_manager = await ConversationManagerFactory.create_manager("azure")
            except Exception:
    ...
    def _init_response_generator(self):
        ...
        try:
            ...
            self.response_generator = ResponseGeneratorFactory.get_generator("rag", config)
        except Exception as e:
    ...
    async def generate_response(
        ...
        # Fall back to the original implementation
        print("Response generator not available, falling back to original implementation")
