...
class SlackUserProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ('slack_id', 'slack_name', 'slack_email', 'interaction_count', 'last_interaction')
    list_filter = ('response_format_preference',)
    search_fields = ('slack_id', 'slack_name', 'slack_email', 'slack_real_name', 'slack_display_name')
    readonly_fields = ('created_at', 'modified_at', 'interaction_count', 'last_interaction')
    fieldsets = (
        ('Slack Information', {
            'fields': ('slack_id', 'slack_name', 'slack_email', 'slack_real_name', 'slack_display_name', 'slack_team_id')
        }),
        ('User Preferences', {
