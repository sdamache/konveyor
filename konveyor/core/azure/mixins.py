...
class ServiceLoggingMixin:
    ...
    def log_azure_credentials(self, service: str, endpoint: Optional[str], key: Optional[str]) -> None:
...
class AzureClientMixin:
    ...
    def initialize_openai_client(self, endpoint: str, api_key: str, api_version: str = "2024-12-01-preview",
                               embedding_deployment: str = "embeddings", gpt_deployment: str = "gpt-deployment") -> tuple:
        """Initialize Azure OpenAI clients."""
        try:
            # Extract base endpoint if it includes deployment
            base_endpoint = endpoint.split("/deployments/")[0] if "/deployments/" in endpoint else endpoint
            ...
            logger.info(f"Successfully initialized Azure OpenAI client with API version {api_version}")
    ...
    def initialize_search_client(self, endpoint: str, api_key: str, index_name: str) -> tuple:
    ...
    def initialize_document_intelligence_client(self, endpoint: str, api_key: str) -> DocumentIntelligenceClient:
