...
class ContextService:
    ...
    def __init__(self, client_manager: AzureClientManager):
        ...
        _, self.search_client = self.client_manager.get_search_clients('konveyor-documents')
    ...
    async def retrieve_context(
        ...
        search_results = self.search_client.search(
            ...
            select=["id", "content", "document_id", "chunk_id", "chunk_index", "metadata"],  # Fields to retrieve
            top=max_chunks,
            vector_queries=[
                {
