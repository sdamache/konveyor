...
def test_slack_webhook():
    ...
    with patch('konveyor.apps.bot.views_updated.slack_service') as mock_slack_service, \
         patch('konveyor.apps.bot.views_updated.process_message') as mock_process_message:
        ...
        mock_process_message.assert_called_once_with('Hello, world!', 'test_user', 'test_channel')
...
def test_process_message():
    ...
    with patch('konveyor.apps.bot.views_updated.orchestrator') as mock_orchestrator, \
         patch('konveyor.apps.bot.views_updated.conversation_manager') as mock_conversation_manager, \
