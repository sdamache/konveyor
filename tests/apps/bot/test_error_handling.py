...
def test_error_handling_specific_errors():
    ...
    with patch('konveyor.apps.bot.views.slack_service') as mock_slack_service, \
        ...
        mock_orchestrator.process_request_sync.side_effect = ValueError("Invalid input value")
        ...
        assert "I encountered an error while processing your request. Invalid input value" in call_args[0][1]  # text
