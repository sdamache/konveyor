...
class FeedbackService:
    ...
    def update_message_content(self, message_id, channel_id, question=None, answer=None,
...
class TestFeedbackService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.feedback_service = FeedbackService(storage_provider=self.mock_storage_provider)
