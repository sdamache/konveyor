...
def test_conversation_context_management():
    ...
    mock_conversation_manager.get_user_conversations = AsyncMock(return_value=[{"id": "test_conversation_id"}])
    mock_conversation_manager.add_message = AsyncMock(return_value={"id": "test_message_id"})
    mock_conversation_manager.get_conversation_context = AsyncMock(return_value=[
    ...
    with patch('konveyor.apps.bot.views.slack_service') as mock_slack_service, \
         patch('konveyor.apps.bot.views.conversation_manager', mock_conversation_manager), \
