...
class OpenAIClientFactory:
    ...
    @classmethod
    def get_client(cls, client_type: str = "unified", config: Optional[Dict[str, Any]] = None) -> OpenAIClientInterface:
        """
        ...
        if not chat_deployment:
            chat_deployment = os.environ.get("AZURE_OPENAI_CHAT_DEPLOYMENT", "gpt-deployment")
        if not embedding_deployment:
            embedding_deployment = os.environ.get("AZURE_OPENAI_EMBEDDING_DEPLOYMENT", "embeddings")
