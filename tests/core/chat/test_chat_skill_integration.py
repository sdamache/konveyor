...
async def test_chat_skill_integration():
    ...
    with patch('konveyor.core.conversation.factory.ConversationManagerFactory.create_manager') as mock_create_manager, \
         patch('konveyor.core.formatters.factory.FormatterFactory.get_formatter') as mock_get_formatter, \
         patch('konveyor.core.generation.factory.ResponseGeneratorFactory.get_generator') as mock_get_generator:
        
        # Create mock conversation manager
        mock_conversation_manager = AsyncMock()
        mock_conversation_manager.create_conversation.return_value = {"id": "test_conversation_id"}
        mock_conversation_manager.get_conversation_context.return_value = "User: Test query\nAssistant: Test response"
        ...
        mock_response_generator.generate_response.return_value = {"response": "Test response"}
        ...
        mock_formatter.format_message.assert_called_once_with(text="Test message", include_blocks=True)
